    ...
    <TooltipProvider>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          ...
          <CreateCardDialog onCreated={fetchData} existingCards={cards.map((c) => ({ id: c.id, tier: c.tier, balance: c.balance, label: `${c.tier} ••${c.number.slice(-4)}` }))} disabled={isReadOnly} />
        </div>
        ...
        {cards.length > 0 ? (
          ...
          <Card>
            <CardContent className="pt-6 flex flex-col items-center text-center py-12">
              ...
              <CreateCardDialog onCreated={fetchData} existingCards={[]} disabled={isReadOnly} />
            </CardContent>
          </Card>
        )}
