      ...
      <div className="space-y-8 pb-6">
        <div className="flex justify-center py-8">
          <div className="relative w-32 h-32" style={{ perspective: "1000px" }}>
            ...
            >
              <div
                className="absolute inset-0 w-full h-full rounded-full bg-gradient-to-br from-yellow-300 to-yellow-600 border-4 border-yellow-700 flex items-center justify-center text-4xl font-bold text-yellow-900 shadow-xl"
        ...
        <div className="max-w-sm mx-auto space-y-4">
          ...
          <Button onClick={flip} disabled={flipping} className="w-full h-11 font-bold" variant="gradient">
