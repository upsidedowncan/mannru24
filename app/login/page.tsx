...
import { EyeOpenIcon, EyeNoneIcon, LockClosedIcon, ArrowRightIcon } from "@radix-ui/react-icons";
            ...
            {step === "phone" ? (
              <form onSubmit={handlePhoneSubmit} className="space-y-4">
                ...
                <Button type="submit" variant="gradient" className="w-full gap-2" disabled={loading}>
                  {loading ? "Загрузка..." : "Продолжить"} <ArrowRightIcon className="w-4 h-4" />
                </Button>
              </form>
            ) : (
              <form onSubmit={handleLogin} className="space-y-4">
                ...
                <Button type="submit" variant="gradient" className="w-full gap-2" disabled={loading}>
                  {loading ? "Вход..." : "Войти"} <ArrowRightIcon className="w-4 h-4" />
                </Button>
