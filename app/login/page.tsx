...
import { RiEyeLine, RiEyeOffLine, RiLockLine, RiArrowRightLine } from "react-icons/ri";
        ...
        <Card className="w-full max-w-sm">
            ...
            {step === "phone" ? (
              <form onSubmit={handlePhoneSubmit} className="space-y-4">
                ...
                <Button type="submit" variant="gradient" className="w-full gap-2" disabled={loading}>
                  {loading ? "Загрузка..." : "Продолжить"} <RiArrowRightLine className="w-4 h-4" />
                </Button>
              </form>
            ) : (
              <form onSubmit={handleLogin} className="space-y-4">
                ...
                <Button type="submit" variant="gradient" className="w-full gap-2" disabled={loading}>
                  {loading ? "Вход..." : "Войти"} <RiArrowRightLine className="w-4 h-4" />
                </Button>
          ...
          <CardFooter>
            <div className="flex items-center gap-2 text-xs text-muted-foreground w-full p-3 rounded-lg bg-secondary">
              <RiLockLine className="w-3.5 h-3.5 text-emerald-500" />
        ...
        <div className="max-w-sm text-center space-y-6">
          ...
          <div className="space-y-3 text-left">
            <div className="flex items-center gap-3 p-4 rounded-lg bg-background">
              <RiLockLine className="w-5 h-5 text-emerald-500" />
              <div>
