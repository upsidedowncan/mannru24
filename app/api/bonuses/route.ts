...
function ensureBaseData() {
  ...
  if (db.tasks.length === 0) {
    db.user = {
      ...
      totalEarned: 16650, totalSpent: 8450, streak: 7, level: 3, xp: 15,
    };
    db.tasks = [
    ...
    db.bonuses = [
      ...
      { id: "bonus-2", title: "Бесплатная подписка 3 месяца", description: "Бесплатная подписка на музыку при оплате картой Маннру", points: 300, category: "Акции", expires: "7 дней", activated: true },
...
export async function GET() {
  ...
  return NextResponse.json(db.bonuses);
}
